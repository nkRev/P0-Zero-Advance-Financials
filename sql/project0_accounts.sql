...
CREATE TABLE `accounts` (
  ...
  CONSTRAINT `account_number_fk` FOREIGN KEY (`account_number`) REFERENCES `transactions` (`account_number`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2021-08-10 20:26:17
